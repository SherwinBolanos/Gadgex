...
//Checks if the form with the name submit is submitted.
//Retrieves and sanitizes input values for updating the admin's name and password.
//Updates the admin's name in the admins table using a prepared statement.
//Validates the old password and updates the password if the old password matches and the new password is confirmed.
?>
...
<!-- Defines a section for updating the admin profile with a heading.
Provides a form with input fields for updating the admin's username, old password, new password, and confirming the new password. -->
